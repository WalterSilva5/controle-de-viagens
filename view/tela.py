...
"border-radius:5px;")
        ...
        self.tabelaListagemViagens.setColumnCount(10)
        ...
        item = QtWidgets.QTableWidgetItem()
        self.tabelaListagemViagens.setHorizontalHeaderItem(9, item)
...
"border-radius:5px;")
        ...
        self.frameExcluirViagem = QtWidgets.QFrame(self.centralwidget)
        self.frameExcluirViagem.setGeometry(QtCore.QRect(10, 10, 800, 600))
        self.frameExcluirViagem.setMinimumSize(QtCore.QSize(800, 600))
        self.frameExcluirViagem.setMaximumSize(QtCore.QSize(800, 600))
        self.frameExcluirViagem.setStyleSheet("background-color:white;")
        self.frameExcluirViagem.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frameExcluirViagem.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frameExcluirViagem.setObjectName("frameExcluirViagem")
        self.labelTelaInicialTitulo1_3 = QtWidgets.QLabel(self.frameExcluirViagem)
        self.labelTelaInicialTitulo1_3.setGeometry(QtCore.QRect(240, 10, 301, 71))
        font = QtGui.QFont()
        font.setPointSize(24)
        font.setBold(True)
        font.setWeight(75)
        self.labelTelaInicialTitulo1_3.setFont(font)
        self.labelTelaInicialTitulo1_3.setStyleSheet("color:blue;")
        self.labelTelaInicialTitulo1_3.setObjectName("labelTelaInicialTitulo1_3")
        self.label_12 = QtWidgets.QLabel(self.frameExcluirViagem)
        self.label_12.setGeometry(QtCore.QRect(30, 120, 161, 41))
        font = QtGui.QFont()
        font.setPointSize(14)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.entradaIdViagemExcluir = QtWidgets.QLineEdit(self.frameExcluirViagem)
        self.entradaIdViagemExcluir.setGeometry(QtCore.QRect(190, 120, 271, 41))
        self.entradaIdViagemExcluir.setObjectName("entradaIdViagemExcluir")
        self.botaoExcluirViagemVoltar = QtWidgets.QPushButton(self.frameExcluirViagem)
        self.botaoExcluirViagemVoltar.setGeometry(QtCore.QRect(10, 520, 161, 41))
        font = QtGui.QFont()
        font.setPointSize(28)
        font.setBold(True)
        font.setWeight(75)
        self.botaoExcluirViagemVoltar.setFont(font)
        self.botaoExcluirViagemVoltar.setStyleSheet("color: red;\n"
"border:1px solid red;\n"
"border-radius:5px;")
        self.botaoExcluirViagemVoltar.setObjectName("botaoExcluirViagemVoltar")
        self.botaoExcluirViagemExcluir = QtWidgets.QPushButton(self.frameExcluirViagem)
        self.botaoExcluirViagemExcluir.setGeometry(QtCore.QRect(500, 120, 161, 41))
        font = QtGui.QFont()
        font.setPointSize(20)
        font.setBold(True)
        font.setWeight(75)
        self.botaoExcluirViagemExcluir.setFont(font)
        self.botaoExcluirViagemExcluir.setStyleSheet("color: red;\n"
"border:1px solid blue;\n"
"border-radius:5px;")
        self.botaoExcluirViagemExcluir.setObjectName("botaoExcluirViagemExcluir")
        self.labelExcluirViagemMensagem = QtWidgets.QLabel(self.frameExcluirViagem)
        self.labelExcluirViagemMensagem.setGeometry(QtCore.QRect(250, 210, 181, 31))
        font = QtGui.QFont()
        font.setPointSize(14)
        font.setBold(True)
        font.setWeight(75)
        self.labelExcluirViagemMensagem.setFont(font)
        self.labelExcluirViagemMensagem.setStyleSheet("color:red;")
        self.labelExcluirViagemMensagem.setText("")
        self.labelExcluirViagemMensagem.setObjectName("labelExcluirViagemMensagem")
        self.frameCadastrarViagem.raise_()
        self.frameRelatorioDeViagens.raise_()
        self.frameExcluirViagem.raise_()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.botaoTelaInicialModificarViagem.setText(_translate("MainWindow", "EXCLUIR VIAGEM"))
        ...
        item = self.tabelaListagemViagens.horizontalHeaderItem(9)
        item.setText(_translate("MainWindow", "ID VIAGEM"))
        ...
        self.labelTelaInicialTitulo1_3.setText(_translate("MainWindow", "EXCLUIR VIAGEM"))
        self.label_12.setText(_translate("MainWindow", "ID DA VIAGEM"))
        self.botaoExcluirViagemVoltar.setText(_translate("MainWindow", "voltar"))
        self.botaoExcluirViagemExcluir.setText(_translate("MainWindow", "EXCLUIR"))
